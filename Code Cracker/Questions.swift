...
class Questions {
    ...
    let jv7 = Question(imgName: "None", questionText: "What is the space complexity of merge sort?", options: ["Ω (n)", "Ω (n ^ 2)", "Ω (n log n)", "Ω (log n)"], correctAns: 1, quesNum:7, wrongAns: -1, explain:"The best case for merge sort is Ω (n) because you have to store your list somewhere.", isAnswered: false)
    ...
    let jv11 = Question(imgName: "None", questionText: "Find a simple f(N) such that the runtime R(n) ∈ Θ(f(n)) ?", options: ["n", "log n", "n ^ 2", "2 ^ n"], correctAns: 1, quesNum:11, wrongAns: -1, explain:"Everytime we increase n by 1. We double the work. Try drawing a tree to help visualize why this is true. ", isAnswered: false)
    ...
    let jv17 = Question(imgName: "None", questionText: "What is the Dijkstra's algorith used for?", options: ["Determining if a graph is acylcic", "Determining the shortest path from a source to all other nodes", "Find the minimum spanning tree in a graph", "None of the above"], correctAns: 2, quesNum:17, wrongAns: -1, explain:"Dijkstra's algorithm, along with Prim's algorithm, is the industry standard for finding the shortest paths between nodes in a graph. ", isAnswered: false)
    ...
    let jv21 = Question(imgName: "None", questionText: "What is the runtime of the function 30 cos(N) + 2N ^ 3?", options: ["Θ (N)", "Θ (30 cos (N))", "O (N)", "Θ (N ^ 3)"], correctAns: 2, quesNum:21, wrongAns: -1, explain:"Θ(f(N)) is defined as there being some positive constants a and b such that a · f(N) ≤ f(N) ≤ b · f(N). In this case, we focus on the 2N ^ 3, which has the simple function of N ^ 3, since 2 is between 1 · N ^ 3 ≤ 2 · N ^ 3 ≤ 3 · N ^ 3 ", isAnswered: false)
    ...
    let jv25 = Question(imgName: "None", questionText: "When does Dijkstra's algoirthm not work??", options: ["If there are two edges that are the same length", "Some of the edges are negative", "The graph is a cycle", "Dijkstra's algorithm always works"], correctAns: 1, quesNum:25, wrongAns: -1, explain:"Dijkstra's algorithm assumes a path can only become heavier and therefore will \"ignore\" the negative edge while traversing the graph as it has already marked the node as complete. ", isAnswered: false)
    let jv26 = Question(imgName: "None", questionText: "Given an undirected graph, a spanning tree T is a subgraph of G, where T?", options: ["is connected", "is acyclic", "includes all of the vericies", "All of the above"], correctAns: 1, quesNum:26, wrongAns: -1, explain:"Spanning trees must be connected and acylic to be considered a tree. It must also include all of the vertices of the graph to be spanning.", isAnswered: false)
    ...
    let jv28 = Question(imgName: "None", questionText: "What is the runtime to get an item from a balanced BST?", options: ["Θ (log n)", "Θ (n)", "Θ (n log n)", "Θ (1)"], correctAns: 0, quesNum:28, wrongAns: -1, explain:"Since the height of the tree is approximately log n, we have to search a max of log n items", isAnswered: false)
    ...
    let py15 = Question(imgName: "None", questionText: "What is a disadvantage of multiple inheritance?", options: ["It can lead to a lot of confusion and ambiguity when two base classes implement a method with the same name", "There are no disadvantages", "It prevents the child class from making a constructor", "None of the above"], correctAns: 0, quesNum:15,wrongAns: -1, explain:"Explain",isAnswered: false)
    ...
    let cd1 = Question(imgName: "c1", questionText: "", options: ["arr.length - i", "arr.length", "arr.length - i - 1","arr.length/2 + i"], correctAns: 2, quesNum:1,wrongAns: -1, explain:"Since the for loop starts at the first index of the array. We want to start j at the middle of the array and iterate from the middle to the end.",isAnswered: false)
       ...
       let cd2 = Question(imgName: "c1",questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:2,wrongAns: -1, explain:"Explain2",isAnswered: false)
       let cd3 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:3,wrongAns: -1, explain:"Explain3",isAnswered: false)
       let cd4 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:4,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd5 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 2, quesNum:5,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd6 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:6,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd7 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:7,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd8 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 2, quesNum:8,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd9 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:9,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd10 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 2, quesNum:10,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd11 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:11,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd12 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:12,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd13 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:13,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd14 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:14,wrongAns: -1, explain:"Explain",isAnswered: false)
       ...
       let cd16 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:16,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd17 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:17,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd18 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:18,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd19 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:19,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd20 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 0, quesNum:20,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd21 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:21,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd22 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 2, quesNum:22,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd23 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:23,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd24 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 2, quesNum:24,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd25 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:25,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd26 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 1, quesNum:26,wrongAns: -1, explain:"Explain",isAnswered: false)
       let cd27 = Question(imgName: "None", questionText: "", options: ["", "", "", ""], correctAns: 3, quesNum:27,wrongAns: -1, explain:"Explain",isAnswered: false)
