...
//  Code Cracker
//
//  Created by Justin Zhang on 7/6/20.
...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        NSLayoutConstraint.activate([
            ...
            popupButton.widthAnchor.constraint(equalToConstant: 60),
            popupButton.centerXAnchor.constraint(equalTo:popupView.centerXAnchor),
